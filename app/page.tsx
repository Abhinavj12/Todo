  ...
  return (
    <div className="flex flex-col min-h-screen">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Stay organized, prioritize your work, and never miss a deadline with our powerful task management app.
                </p>
              </div>
            ...
            <div className="grid gap-6 lg:grid-cols-3 lg:gap-12">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Set deadlines for your tasks and get reminders to stay on track.
                  </p>
                </div>
              </div>
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Access your tasks from any device with our mobile-friendly interface.
                  </p>
                </div>
              </div>
            </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2023 TaskFlow Inc. All rights reserved.</p>
